...
#检查input文件是否存在所有参数
y=yA+yB+yC+yD
if IO=='' or sheet=='' or k=='' or dz=='' or Z=='' or dt=='' or T=='' or vs=='' or P=='' or T0=='' or eb=='' or ep=='' or BTTC=='' or y==0 :
...
#OUTPUT编号
             ...
             output_time_error3=open(r'OUTPUT/%s'%(filename_time_error3),'w')#带有变量，字符中带有变量，‘%s'%(变量)
             for l in range(len(G)):
...
def DATA_output(unit_of_time='h'):
    ...
    if A_min<0  or qA_min<0 or A_max>cmax or B_min<0 or qB_min<0 or B_max>cmax or C_min<0  or qC_min<0 or C_max>cmax or  D_min<0  or qD_min<0 or D_max>cmax or nanA_max==True or nanA_min==True or nanqA_min==True or nanB_max==True or nanB_min==True or nanqB_min==True or nanC_max==True or nanC_min==True or nanqC_min==True or nanD_max==True or nanD_min==True or nanqD_min==True:
       ...
       output_data_error1=open(r'OUTPUT/%s'%(filename_data_error1),'w')#带有变量，字符中带有变量，‘%s'%(变量)
       for l in range(len(G)):
    ...
    if A_min==0 and  qA_min==0 and A_max<=cmax and B_min==0 and  qB_min==0 and B_max<=cmax and C_min==0 and  qC_min==0 and C_max<=cmax and D_min==0 and qD_min==0 and D_max<=cmax :
       ...
       if BTTC=='No':
          ...
          if yA !=0 :
             ...
             output_A=open(r'DATA/%s'%(filename_A),'w')
          ...
          if yB !=0 :
             ...
             output_B=open(r'DATA/%s'%(filename_B),'w')
          ...
          if yC !=0 :
             ...
             output_C=open(r'DATA/%s'%(filename_C),'w')
          ...
          if yD !=0 : 
             ...
             output_D=open(r'DATA/%s'%(filename_D),'w')
...
#h        
          if unit_of_time=='h':     
             ...
             output_TIME=open(r'DATA/%s'%(filename_TIME),'w')#带有变量，字符中带有变量，‘%s'%(变量) 'C:/Users/Eden/Desktop/%s'%(filename)
...
#s        
       ...
       if BTTC=='Yes':
          ...
          if dC_A<0 or dC_B<0 or dC_C<0 or dC_D<0 :             
             ...
             output_data_error2=open(r'OUTPUT/%s'%(filename_data_error2 ),'w')#带有变量，字符中带有变量，‘%s'%(变量)             
             for l in range(len(G)):
...
#h        
          if unit_of_time=='h':     
             ...
             output_TIME_h=open(r'DATA/%s'%(filename_TIME_h),'w')#带有变量，字符中带有变量，‘%s'%(变量) 'C:/Users/Eden/Desktop/%s'%(filename)
...
#min        
          if unit_of_time=='min':     
             ...
             output_TIME_min=open(r'DATA/%s'%(filename_TIME_min),'w')#带有变量，字符中带有变量，‘%s'%(变量) 'C:/Users/Eden/Desktop/%s'%(filename)
...
#s        
          if unit_of_time=='s':     
             ...
             output_TIME_s=open(r'DATA/%s'%(filename_TIME_s),'w')#带有变量，字符中带有变量，‘%s'%(变量) 'C:/Users/Eden/Desktop/%s'%(filename)
...
#绘图                         
           if yA ==0 and yB !=0 and yC !=0 and yD !=0 :
              Y_MAX=np.max([B_max/CB_0,C_max/CC_0,D_max/CD_0])
                   
           if yA !=0 and yB ==0 and yC !=0 and yD !=0 :
              Y_MAX=np.max([A_max/CA_0,C_max/CC_0,D_max/CD_0])
                
           if yA !=0 and yB !=0 and yC ==0 and yD !=0 :
              Y_MAX=np.max([A_max/CA_0,B_max/CB_0,D_max/CD_0])
               
           if yA !=0 and yB !=0 and yC !=0 and yD ==0 :
              Y_MAX=np.max([A_max/CA_0,B_max/CB_0,C_max/CC_0])
              
           if yA ==0 and yB ==0 and yC !=0 and yD !=0 :
              Y_MAX=np.max([C_max/CC_0,D_max/CD_0])  
              
           if yA ==0 and yB !=0 and yC ==0 and yD !=0 :
              Y_MAX=np.max([B_max/CB_0,D_max/CD_0])   
           
           if yA ==0 and yB !=0 and yC !=0 and yD ==0 :
              Y_MAX=np.max([B_max/CB_0,C_max/CC_0])    
           
           if yA !=0 and yB ==0 and yC ==0 and yD !=0 :
              Y_MAX=np.max([A_max/CA_0,D_max/CD_0])  
           
           if yA !=0 and yB ==0 and yC !=0 and yD ==0 :
              Y_MAX=np.max([A_max/CA_0,C_max/CC_0])  
              
           if yA !=0 and yB !=0 and yC ==0 and yD ==0 :
              Y_MAX=np.max([A_max/CA_0,B_max/CB_0])
              
           if yA ==0 and yB ==0 and yC ==0 and yD !=0 :
              Y_MAX=np.max([D_max/CD_0])   
              
           if yA ==0 and yB ==0 and yC !=0 and yD ==0 :
              Y_MAX=np.max([C_max/CC_0])   
              
           if yA ==0 and yB !=0 and yC ==0 and yD ==0 :
              Y_MAX=np.max([B_max/CB_0]) 
              
           if yA !=0 and yB ==0 and yC ==0 and yD ==0 :
              Y_MAX=np.max([A_max/CA_0]) 
            
           if yA !=0 and yB !=0 and yC !=0 and yD !=0 :
              Y_MAX=np.max([A_max/CA_0,B_max/CB_0,C_max/CC_0,D_max/CD_0])       
           ...
           if unit_of_time=='h' :                 
              ...
              if save_figure=='No':
                 if system == 'nt' :
                    ...
                    output_figure_error1=open(r'OUTPUT/%s'%(filename_figure_error1),'w')#带有变量，字符中带有变量，‘%s'%(变量)
                    for l in range(len(G)):
           ...
           if unit_of_time=='min' :                 
              ...
              if save_figure=='No':
                 if system == 'nt' :
                    ...
                    output_figure_error2=open(r'OUTPUT/%s'%(filename_figure_error2),'w')#带有变量，字符中带有变量，‘%s'%(变量)
                    for l in range(len(G)):
...
#s         
           ...
           if unit_of_time=='s' :                 
              ...
              if save_figure=='No':
                 if system == 'nt' :
                    ...
                    output_figure_error3=open(r'OUTPUT/%s'%(filename_figure_error3),'w')#带有变量，字符中带有变量，‘%s'%(变量)
                    for l in range(len(G)):
        ...
        if BTTC=='Yes':   
           ...
           if dC_A<0 or dC_B<0 or dC_C<0 or dC_D<0 :             
              ...
              output_figure_error4=open(r'OUTPUT/%s'%(filename_figure_error4),'w')#带有变量，字符中带有变量，‘%s'%(变量)
              for l in range(len(G)):
              ...
              if unit_of_time=='h' :
                 ...
                 if save_figure=='No':
                    if system == 'nt' :
                       ...
                       output_figure_error5=open(r'OUTPUT/%s'%(filename_figure_error5),'w')#带有变量，字符中带有变量，‘%s'%(变量)
                       for l in range(len(G)):
              ...
              if unit_of_time=='min' :
                 ...
                 if save_figure=='No':
                    if system == 'nt' :
                       ...
                       output_figure_error6=open(r'OUTPUT/%s'%(filename_figure_error6),'w')#带有变量，字符中带有变量，‘%s'%(变量)
                       for l in range(len(G)):
              ...
              if unit_of_time=='s' :
                 ...
                 if save_figure=='No':
                    if system == 'nt' :
                       ...
                       output_figure_error7=open(r'OUTPUT/%s'%(filename_figure_error7),'w')#带有变量，字符中带有变量，‘%s'%(变量)
                       for l in range(len(G)):
